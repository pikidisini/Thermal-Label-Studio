          ...
          <nav className="hidden lg:flex items-center gap-0.5 ml-2 border-l border-outline-variant pl-3 relative">
              ...
              {openMenu === 'file' && (
                ...
                >
                  <button
                    ...
                    className="w-full px-3 py-1.5 text-left text-on-surface hover:bg-surface-container flex items-center gap-2"
                  >
                  ...
                  >
                    ...
                    <span>Save Template to Server</span>
                  </button>
                </div>
              )}
            </div>
            ...
            <div className="relative flex items-center pl-1">
              ...
              <select
                ...
                className="pl-6 pr-2 py-0.5 bg-surface border border-outline-variant text-[11px] rounded text-on-surface focus:outline-none focus:border-primary cursor-pointer max-w-[180px] truncate font-medium"
              >
                {templates.map(t => (
