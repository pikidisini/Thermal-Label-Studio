        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div className="flex flex-col items-center gap-1 w-full">
            <button
              ...
              title="Text Label [T] (Click to Add / [T] Draw)"
            >
              {activeTool === 'text' && (
                <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-primary" />
              )}
            ...
            <button
              ...
              title="1D Linear Barcode [B] (Click to Add)"
            >
              {activeTool === 'barcode' && (
                <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-primary" />
              )}
            ...
            <button
              type="button"
              data-testid="btn-add-qrcode"
              onClick={() => {
                onAddQrCode?.('https://sap.corp');
                setActiveTool?.('select');
              }}
              className={`relative group w-[38px] h-[32px] flex items-center justify-center rounded-sm transition ${
                activeTool === 'qrcode'
              ...
              title="2D DataMatrix / QR [M] (Click to Add)"
            >
              {activeTool === 'qrcode' && (
          ...
          <div className="flex flex-col items-center gap-1 w-full">
            <button
              ...
              onClick={() => onAddIsoSymbol?.('fragile', 'Fragile')}
              ...
              title="Industrial ISO Fragile / Hazard Symbol"
            >
